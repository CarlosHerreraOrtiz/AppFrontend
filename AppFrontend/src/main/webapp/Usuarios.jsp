				...
				<div>
					<form class="form-sign" method="GET" action="Controlador"
						...
						<div class="form-group">
							<label>Cedula:</label> <input type="text" name="txtcedula"
								class="form-control"
						...
						<div class="form-group">
							<label>Apellido:</label> <input type="text" name="txtapellido"
								class="form-control"
								value="${usuarioSeleccionado.getApellido_usuario()}">
						</div>
						...
						<div class="form-group">
							<label>Tipo:</label> <input type="text" name="txttipo"
								class="form-control"
								value="${usuarioSeleccionado.getTipo_usuario()}">
						</div>

						<div class="form-group">
							<label>Estado:</label> <input type="text" name="txtestado"
								class="form-control"
								value="${usuarioSeleccionado.getEstado_usuario()}">
						</div>
